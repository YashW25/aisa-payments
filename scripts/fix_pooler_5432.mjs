...
async function run() {
  try {
    ...
    console.log('Testing username format postgres.uyqcffnqunymjzlakyho on port 5432...');

    // On Supabase session pooler, port 5432 works with username postgres.<project_ref>
