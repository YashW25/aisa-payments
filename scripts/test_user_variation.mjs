...
async function run() {
  try {
    ...
    console.log('Testing username format uyqcffnqunymjzlakyho on pooler port 6543...');

    // Username variations: uyqcffnqunymjzlakyho or postgres:uyqcffnqunymjzlakyho
    const poolerUrl = 'postgresql://uyqcffnqunymjzlakyho:ASDFGHJKLasdfghjkl%21%40%23%24%25%5E%26%2A%28%291234567890@aws-0-ap-south-1.pooler.supabase.com:6543/postgres?pgbouncer=true';
