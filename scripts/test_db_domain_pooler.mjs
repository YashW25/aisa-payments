...
async function run() {
  try {
    ...
    console.log('Testing username format postgres.uyqcffnqunymjzlakyho with standard pooler hostname...');

    // In Supabase, the pooler database user for database project ref 'uyqcffnqunymjzlakyho' is:
    // postgres.uyqcffnqunymjzlakyho
    // And pooler host: postgres.uyqcffnqunymjzlakyho@aws-0-ap-south-1.pooler.supabase.com:6543
    // Let's test with host db.uyqcffnqunymjzlakyho.supabase.co and user postgres.uyqcffnqunymjzlakyho
