...
async function run() {
  try {
    ...
    console.log('Testing username postgres.uyqcffnqunymjzlakyho on aws-0-ap-south-1.pooler.supabase.com port 6543...');

    // Exact Supabase Pooler URI structure:
    // postgres.ref:password@aws-0-region.pooler.supabase.com:6543/postgres?pgbouncer=true
