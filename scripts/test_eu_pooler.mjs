...
async function run() {
  try {
    ...
    console.log('Testing username format postgres.uyqcffnqunymjzlakyho on pooler hostname aws-0-eu-central-1.pooler.supabase.com...');

    // Testing alternative Supabase pooler region hostnames (eu-central-1 / us-east-1)
    const poolerUrl = 'postgresql://postgres.uyqcffnqunymjzlakyho:ASDFGHJKLasdfghjkl%21%40%23%24%25%5E%26%2A%28%291234567890@aws-0-eu-central-1.pooler.supabase.com:6543/postgres?pgbouncer=true';
