...
async function run() {
  try {
    ...
    console.log('Testing username format postgres.uyqcffnqunymjzlakyho on pooler hostname aws-0-ap-south-1.pooler.supabase.com:6543...');

    // Supabase Pooler URI format:
    // postgresql://postgres.uyqcffnqunymjzlakyho:PASSWORD@aws-0-ap-south-1.pooler.supabase.com:6543/postgres
    const poolerUrl = 'postgresql://postgres.uyqcffnqunymjzlakyho:ASDFGHJKLasdfghjkl%21%40%23%24%25%5E%26%2A%28%291234567890@aws-0-ap-south-1.pooler.supabase.com:6543/postgres';
